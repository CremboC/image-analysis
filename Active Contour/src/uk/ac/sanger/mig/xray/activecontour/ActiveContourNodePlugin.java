 ...
 */
public class ActiveContourNodePlugin extends Plugin {
    // The shared instance.
    private static ActiveContourNodePlugin plugin;

    /**
     * The constructor.
     */
    public ActiveContourNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ActiveContourNodePlugin getDefault() {
        return plugin;
    }
