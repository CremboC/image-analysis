 ...
 * @author Paulius @ WTSI
 */
public class BitmaskCropperNodePlugin extends Plugin {
    // The shared instance.
    private static BitmaskCropperNodePlugin plugin;

    /**
     * The constructor.
     */
    public BitmaskCropperNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BitmaskCropperNodePlugin getDefault() {
        return plugin;
    }
