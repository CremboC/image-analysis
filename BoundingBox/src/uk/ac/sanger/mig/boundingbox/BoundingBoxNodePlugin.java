 ...
 */
public class BoundingBoxNodePlugin extends Plugin {
    // The shared instance.
    private static BoundingBoxNodePlugin plugin;

    /**
     * The constructor.
     */
    public BoundingBoxNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BoundingBoxNodePlugin getDefault() {
        return plugin;
    }
