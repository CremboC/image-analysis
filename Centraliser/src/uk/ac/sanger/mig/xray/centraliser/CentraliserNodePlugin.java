 ...
 */
public class CentraliserNodePlugin extends Plugin {
    // The shared instance.
    private static CentraliserNodePlugin plugin;

    /**
     * The constructor.
     */
    public CentraliserNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CentraliserNodePlugin getDefault() {
        return plugin;
    }
