...
/**
 * <code>NodeView</code> for the "Centraliser" Node. Centres a blob of white
...
public class CentraliserNodeView extends NodeView<CentraliserNodeModel> {
	 ...
	 * 
	 * @param nodeModel
	 *            The model (class: {@link CentraliserNodeModel})
	 */
	...
	protected void modelChanged() {
		CentraliserNodeModel nodeModel = (CentraliserNodeModel) getNodeModel();
