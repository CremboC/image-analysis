 ...
 * @author pi1
 */
public class AlignerNodePlugin extends Plugin {
    // The shared instance.
    private static AlignerNodePlugin plugin;

    /**
     * The constructor.
     */
    public AlignerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static AlignerNodePlugin getDefault() {
        return plugin;
    }
