 ...
 */
public class PeakCounterNodePlugin extends Plugin {
    // The shared instance.
    private static PeakCounterNodePlugin plugin;

    /**
     * The constructor.
     */
    public PeakCounterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PeakCounterNodePlugin getDefault() {
        return plugin;
    }
