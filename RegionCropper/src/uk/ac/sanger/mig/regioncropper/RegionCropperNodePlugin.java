 ...
 */
public class RegionCropperNodePlugin extends Plugin {
    // The shared instance.
    private static RegionCropperNodePlugin plugin;

    /**
     * The constructor.
     */
    public RegionCropperNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RegionCropperNodePlugin getDefault() {
        return plugin;
    }
