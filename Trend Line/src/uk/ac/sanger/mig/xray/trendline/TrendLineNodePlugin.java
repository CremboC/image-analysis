 ...
 */
public class TrendLineNodePlugin extends Plugin {
    // The shared instance.
    private static TrendLineNodePlugin plugin;

    /**
     * The constructor.
     */
    public TrendLineNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TrendLineNodePlugin getDefault() {
        return plugin;
    }
