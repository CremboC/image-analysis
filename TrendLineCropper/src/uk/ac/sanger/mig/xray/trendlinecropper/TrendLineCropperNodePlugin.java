 ...
 */
public class TrendLineCropperNodePlugin extends Plugin {
    // The shared instance.
    private static TrendLineCropperNodePlugin plugin;

    /**
     * The constructor.
     */
    public TrendLineCropperNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static TrendLineCropperNodePlugin getDefault() {
        return plugin;
    }
